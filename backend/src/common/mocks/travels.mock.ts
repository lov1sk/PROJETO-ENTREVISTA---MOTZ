    ...
    delivers: [
      {
        ...
        originId: 'origin-1',
        origin: TRAVEL_DELIVER_ORIGIN_MOCK[0],
        destinies: [
          TRAVEL_DELIVER_DESTINIES_MOCK[0],
          TRAVEL_DELIVER_DESTINIES_MOCK[1],
        ],
        // originDestiny: {
        //   id: 'origin-destiny-1',
        //   deliverId: 'deliver-1',
      ...
      },
      {
        ...
        originId: 'origin-2',
        origin: TRAVEL_DELIVER_ORIGIN_MOCK[1],
        destinies: [TRAVEL_DELIVER_DESTINIES_MOCK[2]],
        // originDestiny: {
        //   id: 'origin-destiny-2',
        //   deliverId: 'deliver-2',
        //   originLatitude: -23.6815167, // MINHA CASA
    ...
    delivers: [
      {
        ...
        client: CLIENT_MOCK[1],
        originId: 'origin-3',
        origin: TRAVEL_DELIVER_ORIGIN_MOCK[2],
        destinies: [
          TRAVEL_DELIVER_DESTINIES_MOCK[3],
          TRAVEL_DELIVER_DESTINIES_MOCK[4],
        ],
        // originDestiny: {
        //   id: 'origin-destiny-3',
        //   deliverId: 'deliver-3',
